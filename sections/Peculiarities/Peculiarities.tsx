...
const Peculiarities: React.FC<PeculiaritiesProps> = ({ data }) => {
  const peculiaritiesFirstRef = useRef(null);
  const peculiaritiesSecondRef = useRef(null);
  const [isVisibleFirst, setIsVisibleFirst] = useState(false);
  const [isVisibleSecond, setIsVisibleSecond] = useState(false);

  const onScreenFirst = useOnScreen(peculiaritiesFirstRef, 0.3);
  const onScreenSecond = useOnScreen(peculiaritiesSecondRef, 0.3);
